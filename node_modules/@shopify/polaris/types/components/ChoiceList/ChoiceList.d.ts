...
declare function ChoiceList({ title, titleHidden, allowMultiple, choices, selected, onChange, error, disabled, name, }: CombinedProps): JSX.Element;
declare const _default: React.ComponentClass<Props, any> & typeof ChoiceList;
