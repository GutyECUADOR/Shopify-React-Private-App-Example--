...
import { Consumer } from '../ResourceList';
...
class Filters extends React.Component {
    ...
    render() {
        const { filters, queryValue, onQueryBlur, onQueryChange, onQueryFocus, focused, onClearAll, appliedFilters, polaris: { intl }, onQueryClear, queryPlaceholder, context: { resourceName }, children, } = this.props;
...
export default compose(withAppProvider(), withContext(Consumer))(Filters);
