...
function Cell({ content, contentType, firstColumn, truncate, header, total, sorted, sortable, sortDirection, verticalAlign = 'top', defaultSortDirection = 'ascending', polaris: { intl: { translate }, }, onSort, }) {
