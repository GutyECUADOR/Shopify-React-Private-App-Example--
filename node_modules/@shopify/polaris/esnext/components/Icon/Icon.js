...
function Icon({ source, color, backdrop, accessibilityLabel, untrusted = false, polaris: { intl }, }) {
    ...
    if (source === 'placeholder') {
        ...
        // eslint-disable-next-line no-console
        console.warn(`Deprecation: passing the string "${source}" into <Icon source> is deprecated and will be removed in the next major version. Pass in the "${componentImportName}" React Component from the @shopify/polaris-icons package instead.`);
