...
class FilterControl extends React.Component {
    constructor() {
        super(...arguments);
        this.handleAddFilter = (newFilter) => {
    ...
    render() {
        const { searchValue, appliedFilters = [], additionalAction, focused = false, filters = [], placeholder, onSearchBlur, onSearchChange, polaris: { intl }, context: { selectMode, resourceName }, } = this.props;
